...
- [x] Implement **Push Clipboard Into FileMaker** action to:
...
- [x] Ensure the action is only enabled when:
  - [x] A project is open
...
- [x] Add tests for enabling/disabling the action under different editor contexts
...
- [x] Add quick actions or context menu entries in Project View or Editor (if beneficial)
...
- [x] Add a short in-IDE help section or link to documentation
- [x] Document known limitations and future ideas
